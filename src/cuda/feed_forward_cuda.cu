...
Matrix FeedForward::backward_cuda_impl(const Matrix &grad,
  ...
  CUDA_LAUNCH(feed_forward_backward_kernel_1, grid, block, 0, nullptr, d_grad,
              d_w2, d_intermediate, batch_size, hidden_size, intermediate_size);

  // Backward through GELU
  CUDA_LAUNCH(gelu_backward_kernel, grid, block, 0, nullptr, d_intermediate,
              d_input, batch_size * intermediate_size);

  // Second backward pass
  CUDA_LAUNCH(feed_forward_backward_kernel_2, grid, block, 0, nullptr,
